...
CREATE TABLE `auth_group_permissions` (`id` integer NOT NULL AUTO_INCREMENT, `group_id` integer NOT NULL REFERENCES `auth_group` (`id`), `permission_id` integer NOT NULL REFERENCES `auth_permission` (`id`), PRIMARY KEY(id));
DROP TABLE IF EXISTS `auth_permission`;
CREATE TABLE `auth_permission` (`id` integer NOT NULL AUTO_INCREMENT, `content_type_id` integer NOT NULL REFERENCES `django_content_type` (`id`), `codename` varchar(100) NOT NULL, `name` varchar(255) NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE `auth_user` (`id` integer NOT NULL AUTO_INCREMENT, `password` varchar(128) NOT NULL, `last_login` datetime NULL, `is_superuser` bool NOT NULL, `first_name` varchar(30) NOT NULL, `last_name` varchar(30) NOT NULL, `email` varchar(254) NOT NULL, `is_staff` bool NOT NULL, `is_active` bool NOT NULL, `date_joined` datetime NOT NULL, `username` varchar(150) NOT NULL UNIQUE, PRIMARY KEY(id));
...
CREATE TABLE `auth_user_groups` (`id` integer NOT NULL AUTO_INCREMENT, `user_id` integer NOT NULL REFERENCES `auth_user` (`id`), `group_id` integer NOT NULL REFERENCES `auth_group` (`id`), PRIMARY KEY(id));
DROP TABLE IF EXISTS `auth_user_user_permissions`;
CREATE TABLE `auth_user_user_permissions` (`id` integer NOT NULL AUTO_INCREMENT, `user_id` integer NOT NULL REFERENCES `auth_user` (`id`), `permission_id` integer NOT NULL REFERENCES `auth_permission` (`id`), PRIMARY KEY(id));
DROP TABLE IF EXISTS `django_admin_log`;
CREATE TABLE `django_admin_log` (`id` integer NOT NULL AUTO_INCREMENT, `object_id` text NULL, `object_repr` varchar(200) NOT NULL, `action_flag` smallint unsigned NOT NULL, `change_message` text NOT NULL, `content_type_id` integer NULL REFERENCES `django_content_type` (`id`), `user_id` integer NOT NULL REFERENCES `auth_user` (`id`), `action_time` datetime NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE `django_content_type` (`id` integer NOT NULL AUTO_INCREMENT, `app_label` varchar(100) NOT NULL, `model` varchar(100) NOT NULL, PRIMARY KEY(id));
...
DROP TABLE IF EXISTS `firstapp_article`;
CREATE TABLE `firstapp_article` (`id` integer NOT NULL AUTO_INCREMENT, `title` varchar(500) NOT NULL, `img` varchar(250) NULL, `content` text NULL, `views` integer NOT NULL, `likes` integer NOT NULL, `createtime` date NOT NULL, PRIMARY KEY(id));
...
DROP TABLE IF EXISTS `firstapp_article_collected_by`;
CREATE TABLE `firstapp_article_collected_by` (`id` integer NOT NULL AUTO_INCREMENT, `article_id` integer NOT NULL REFERENCES `firstapp_article` (`id`), `userprofile_id` integer NOT NULL REFERENCES `firstapp_userprofile` (`id`), PRIMARY KEY(id));
...
DROP TABLE IF EXISTS `firstapp_comment`;
CREATE TABLE `firstapp_comment` (`id` integer NOT NULL AUTO_INCREMENT, `name` varchar(500) NOT NULL, `avatar` varchar(250) NOT NULL, `comment` text NULL, `createtime` date NOT NULL, `belong_to_id` integer NULL REFERENCES `firstapp_article` (`id`), PRIMARY KEY(id));
...
DROP TABLE IF EXISTS `firstapp_ticket`;
CREATE TABLE `firstapp_ticket` (`id` integer NOT NULL AUTO_INCREMENT, `article_id` integer NOT NULL REFERENCES `firstapp_article` (`id`), `voter_id` integer NOT NULL REFERENCES `auth_user` (`id`), `choice` varchar(10) NOT NULL, PRIMARY KEY(id));
...
DROP TABLE IF EXISTS `firstapp_userprofile`;
CREATE TABLE `firstapp_userprofile` (`id` integer NOT NULL AUTO_INCREMENT, `realname` varchar(50) NULL, `sex` varchar(20) NOT NULL, `user_id` integer NOT NULL UNIQUE REFERENCES `auth_user` (`id`), `avatar` varchar(100) NULL, PRIMARY KEY(id));
